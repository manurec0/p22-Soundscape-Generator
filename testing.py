...
download_sounds_freesound(queryText=query, tag=tag, duration=duration, API_Key="xTdc6oqv5FLJQCmdcD8kRKnzuYnScA6vrkXBs36v", outputDir="D:\Desktop", topNResults=number,
                              featureExt='.json')
#francisco lopez
#Chris cutler
#pyo
